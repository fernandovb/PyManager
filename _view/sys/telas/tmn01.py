...
class TMN01 (wx.Frame):
    ...
    def __init__(self, parent):
        ...
        self.lb_executar = wx.StaticText(
            self.tb_mn01, wx.ID_ANY, u"Executar: ", wx.DefaultPosition, wx.Size(68, -1), wx.ALIGN_RIGHT)
        self.lb_executar.Wrap(-1)

        self.tb_mn01.AddControl(self.lb_executar)
        self.tc_executar = wx.TextCtrl(
            self.tb_mn01, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size(-1, -1), 0)
        self.tb_mn01.AddControl(self.tc_executar)
        self.mt_run = self.tb_mn01.AddLabelTool(wx.ID_EXECUTE, u"Executar", wx.Bitmap(
        ...
        self.mt_ok = self.tb_mn01.AddLabelTool(wx.ID_SAVE, u"OK", wx.Bitmap(
        ...
        self.mt_cancel = self.tb_mn01.AddLabelTool(wx.ID_CANCEL, u"Fechar", wx.Bitmap(
        ...
        self.mt_find = self.tb_mn01.AddLabelTool(wx.ID_FIND, u"Localizar", wx.Bitmap(
            u"desingner/icons/ac_buscar_16x16.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, u"Localiza registro.", None)

        self.tb_mn01.AddSeparator()

        self.mt_insert = self.tb_mn01.AddLabelTool(wx.ID_ADD, u"Novo registro", wx.Bitmap(
            u"desingner/icons/ac_adicionar_16x16.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, u"Cria novo registro", None)

        self.mt_edit = self.tb_mn01.AddLabelTool(wx.ID_EDIT, u"Altera registro", wx.Bitmap(
            u"desingner/icons/ac_editar_16x16.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, u"Altera registro atual", None)

        self.mt_delete = self.tb_mn01.AddLabelTool(wx.ID_DELETE, u"Inativa registro", wx.Bitmap(
            u"desingner/icons/ac_lixeira_16x16.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, u"Inativa o registro atual", None)

        self.tb_mn01.AddSeparator()

        self.mt_print = self.tb_mn01.AddLabelTool(wx.ID_PRINT, u"Envia tela para impressora", wx.Bitmap(
            u"desingner/icons/ac_imprimir_16x16.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, u"Envia dados da tela para impressora", None)

        self.mt_pdf = self.tb_mn01.AddLabelTool(wx.ID_PRINT, u"Envia tela para impressora", wx.Bitmap(
            u"desingner/icons/ac_pdf_16x16.png", wx.BITMAP_TYPE_ANY), wx.NullBitmap, wx.ITEM_NORMAL, wx.EmptyString, u"Gera arquivo PDF com dados da tela", None)

        self.tb_mn01.AddSeparator()

        self.mt_exit = self.tb_mn01.AddLabelTool(wx.ID_EXIT, u"Sair", wx.Bitmap(
