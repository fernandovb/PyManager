...
class TSULOG ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Credenciais", pos = wx.DefaultPosition, size = wx.Size( 233,390 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.tb_mensagem = wx.TextCtrl( lay_mensagem.GetStaticBox(), wx.ID_ANY, u"Bem vindo ao ERP Caseiro. Favor entrar com suas credenciais.", wx.DefaultPosition, wx.DefaultSize, wx.TE_MULTILINE )
